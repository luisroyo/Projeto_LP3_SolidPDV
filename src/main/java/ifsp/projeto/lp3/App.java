...
public class App extends Application {
  ...
  public void start(Stage primaryStage) throws IOException {
   ...
   FXMLLoader fxmlLogin = new FXMLLoader(getClass().getResource("view/telaLogin.fxml"));
   FXMLLoader fxmlMenu = new FXMLLoader(getClass().getResource("view/telaMenu.fxml"));
   FXMLLoader fxmlUsuario = new FXMLLoader(getClass().getResource("view/telaCadastroUsuario.fxml"));
